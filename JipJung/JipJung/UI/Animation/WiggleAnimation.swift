...
final class WiggleAnimation: CAAnimationGroup {
    ...
    private func prepareBezierPaths(frame: CGRect) -> (UIBezierPath, UIBezierPath, UIBezierPath) {
        ...
        bezierPath0.addCurve(
            to: box.bottomRight,
            controlPoint1: CGPoint(
                x: box.minX + box.length * 0.2,
                y: box.maxY + box.length * 0.3
            ),
            controlPoint2: CGPoint(
                x: box.minX + box.length * 0.63,
        ...
        bezierPath0.addCurve(
            to: box.topRight,
            controlPoint1: CGPoint(
                x: box.maxX + box.length * 0.22,
                y: box.maxY - box.length * 0.29
            ),
            controlPoint2: CGPoint(
                x: box.maxX + box.length * 0.23,
        ...
        bezierPath0.addCurve(
            to: box.topLeft,
            controlPoint1: CGPoint(
                x: box.minX + box.length * 0.81,
                y: box.minY - box.length * 0.29
            ),
            controlPoint2: CGPoint(
                x: box.minX + box.length * 0.32,
        ...
        bezierPath2.addCurve(
            to: box.bottomRight,
            controlPoint1: CGPoint(
                x: box.minX + box.length * 0.18,
                y: box.maxY + box.length * 0.25
            ),
            controlPoint2: CGPoint(
                x: box.minX + box.length * 0.75,
